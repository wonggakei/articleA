...
const rules = {
  username: [
    ...
    { min: 5, max: 10, message: '用户名5-10位字符', trigger: 'blur' }
  ],
  password: [
...
.login-page {
  ...
  .bg {
    background:
      url('@/assets/英文潮流文字LOGO.png') no-repeat 50% center / 400px auto,
      url('@/assets/u=3931791030,1793401781&fm=253&fmt=auto&app=138&f=JPEG.webp') no-repeat center / cover;
